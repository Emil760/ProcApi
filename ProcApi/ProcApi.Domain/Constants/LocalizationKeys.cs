namespace ProcApi.Domain.Constants
{
    public static class LocalizationKeys
    {
        ...
        public const string DOCUMENT_NUMBER_SECTION_NOT_FOUND = "DocumentNumberSectionNotFound";
        public const string HAS_ACTIVE_DOCUMENT_NUMBER_PATTERN = "HasActiveDocumentNumberPattern";
        public const string DOCUMENT_NUMBER_PATTERN_NOT_FOUND = "DocumentNumberPatternNotFound";
        ...
        public const string ANNUAL_PROCUREMENT_ALREADY_EXISTS = "AnnualProcurementAlreadyExists";
        public const string ANNUAL_PROCUREMENT_NOT_FOUND = "AnnualProcurementNotFound";
        public const string ACTIVE_ANNUAL_PROCUREMENT_ALREADY_EXISTS = "ActiveAnnualProcurementAlreadyExists";

        public const string PROJECT_NOT_FOUND = "ProjectNotFound";
        public const string PROJECT_NAME_ALREADY_EXISTS = "ProjectNameAlreadyExists";

        public const string DROP_DOWN_ITEM_NAME_ALREADY_EXISTS = "DropDownItemNameAlreadyExists";
        public const string DROP_DOWN_SOURCE_NAME_ALREADY_EXISTS = "DropDownSourceNameAlreadyExists";
        public const string DROP_DOWN_SOURCE_NOT_FOUND = "DropDownSourceNotFound";
        public const string DROP_DOWN_ITEM_SOURCE_NOT_FOUND = "DropDownItemNotFound";

        public const string RESERVED_ITEM_NOT_FOUND = "ReservedItemNotFound";

        public const string GOOD_RECEIPT_NOTE_ITEM_NOT_FOUND = "GoodReceiptNoteItemNotFound";
    }
}
