...
{
    class ReserveItemPfofile : CommonProfile
    {
        public ReserveItemPfofile()
        {
            CreateMap<ReservedItem, ReserveItemResponse>()
             ...
             .ForMember(dest => dest.GoodReceiptNoteNumber, opt => opt.MapFrom(src => src.GoodReceiptNoteItem.GoodReceiptNote.Document.Number))
             .ForMember(dest => dest.MaterialName, opt => opt.MapFrom(src => src.GoodReceiptNoteItem.Material.Name))
             .ForMember(dest => dest.UnitOfMeasureName, opt => opt.MapFrom(src => src.GoodReceiptNoteItem.UnitOfMeasure.Name))
            ...
            CreateMap<GoodReceiptNoteItem, ItemForReservationResponse>()
             ...
             .ForMember(dest => dest.GoodReceiptNoteNumber, opt => opt.MapFrom(src => src.GoodReceiptNote.Document.Number))
